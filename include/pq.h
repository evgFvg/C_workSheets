...
*	delete highest priority element in PQ.
*
* @params:
*	pq - pointer to a PQ.
* 	if the pointer is invalid - behavior is undefined 
...
/*
* PQPeek Description:
*	returns the data of the element with the highest priority in PQ.
*
* @params:
*	pq - pointer to a PQ.
* 	if the pointer is invalid - behavior is undefined.
...
*
* @params:
*	pq_src - Pointer to source PQ that will be merged to dest
* 	pq_dest - Pointer to destination PQ that pq_src will be merged into. After merge, src will be empty.
